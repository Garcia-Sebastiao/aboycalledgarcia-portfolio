  ...
  return (
    ...
    >
      <path
        ...
        stroke="#0095A8"
      />
      <circle cx="8" cy="35" r="8" fill="#00C3D0" />
      <path
        d="M272 15C270.658 65.7754 320.199 119.217 363 132C416.502 147.978 454.371 141.761 463 260"
        stroke="white"
      />
      <circle cx="272" cy="11" r="8" fill="white" />
      <circle cx="502" cy="16" r="8" fill="#0B89CE" />
      <path d="M502 24V270" stroke="#0B89CE" />
      <path
        d="M1016.54 30C1021.1 77.6667 993.827 176 848.17 188C666.099 203 607.366 149 578 260"
        stroke="#036EF2"
      />
      <circle cx="1017" cy="22" r="8" fill="#036EF2" />
      <circle cx="732" cy="8" r="7.5" fill="#FF8D28" stroke="#FF8D28" />
      <path
